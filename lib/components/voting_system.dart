...
class VotingSystem extends StatefulWidget {
  ...
  @override
  State<VotingSystem> createState() => _VotingSystemState();
}

class _VotingSystemState extends State<VotingSystem> {
  bool hasVoted = false;
      ...
      if (!hasVoted) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Vote recorded! +2 points'),
